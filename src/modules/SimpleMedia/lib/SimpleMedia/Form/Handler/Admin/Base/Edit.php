 ...
 */
class SimpleMedia_Form_Handler_Admin_Base_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $this->idValues = SimpleMedia_Util_Controller::retrieveIdentifier($this->request, array(), $this->objectType, $this->idFields);
        $hasIdentifier = SimpleMedia_Util_Controller::isValidIdentifier($this->idValues);
    ...
    public function HandleCommand(Zikula_Form_View $view, &$args)
    {
        ...
        $hookAreaPrefix = 'simplemedia.ui_hooks.' . $this->objectTypeLowerMultiple;
     ...
     */
    protected function processAttributesForUpdate($entity, $entityData)
    {
        if (!isset($entityData['attributes'])) {
            return;
        }

        foreach($entityData['attributes'] as $name => $value) {
            $entity->setAttribute($name, $value);
        }
        unset($entityData['attributes']);
    }
    ...
    public function fetchInputData(Zikula_Form_View $view, &$args)
    {
        ...
        if ($this->hasAttributes) {
            $this->processAttributesForUpdate($entity, $entityData);
        }
    ...
    /**
     * Executing insert and update statements - method stub for child classes.
     *
     * @param Array   $args    arguments from handleCommand method.
     */
