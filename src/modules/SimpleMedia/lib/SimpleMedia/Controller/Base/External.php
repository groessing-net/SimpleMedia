 ...
 */
class SimpleMedia_Controller_Base_External extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function display($args)
    {
        ...
        $repository = $this->entityManager->getRepository('SimpleMedia_Entity_' . ucwords($objectType));
    ...
    public function finder($args)
    {
        ...
        $view->assign('editorName', $editor)
             ...
             ->assign('mainCategory', ModUtil::apiFunc('SimpleMedia', 'category', 'getMainCat', array('ot' => $objectType))
             ->assign('sort', $sort)
             ->assign('sortdir', $sdir)
