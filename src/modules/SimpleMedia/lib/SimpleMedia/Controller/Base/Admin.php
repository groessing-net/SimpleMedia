...
// DEBUG: permission check aspect ends
        ...
        if ($tpl == 'tree') {
            ...
            return SimpleMedia_Util_View::processTemplate($this->view, 'admin', $objectType, 'view', $args);
        }
...
// DEBUG: permission check aspect ends
        ...
        // fetch and return the appropriate template
        return SimpleMedia_Util_View::processTemplate($this->view, 'admin', $objectType, 'display', $args);
    }
...
// DEBUG: permission check aspect ends
        ...
        $handlerClass = 'SimpleMedia_Form_Handler_Admin_' . ucfirst($objectType) . '_Edit';
