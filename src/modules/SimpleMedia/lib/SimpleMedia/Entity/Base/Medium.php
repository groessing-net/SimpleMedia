...
abstract class SimpleMedia_Entity_Base_Medium extends Zikula_EntityAccess
{
    ...
    {
        if ($additionalData != $this->additionalData) {
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                    if (SecurityUtil::checkPermission('SimpleMedia:Medium:', $this->id . '::', ACCESS_EDIT)) {
                $this->_actions[] = array(
    ...
    protected function performPostLoadCallback()
    {
        ...
        $this['additionalData'] = ((isset($this['additionalData']) && is_array($this['additionalData'])) ? DataUtil::formatForDisplay($this['additionalData']) : array());
        $this['sortValue'] = (int) ((isset($this['sortValue']) && !empty($this['sortValue'])) ? DataUtil::formatForDisplay($this['sortValue']) : 0);
        if ($currentFunc != 'edit') {
            $this['mediaType'] = (((isset($this['mediaType']) && !empty($this['mediaType'])) || $this['mediaType'] == 0) ? DataUtil::formatForDisplayHTML($this['mediaType']) : '');
        }
    ...
    * Performs a deep copy. 
    ...
    public function __clone()
    {
        ...
        if ($this->id) {
            ...
            $entity->setAdditionalData($this->getAdditionalData());
