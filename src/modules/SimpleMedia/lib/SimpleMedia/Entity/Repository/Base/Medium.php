...
class SimpleMedia_Entity_Repository_Base_Medium extends EntityRepository
{
    ...
    public function getDescriptionFieldName()
   {
    ...
    protected function getViewQuickNavParameters($context = '', $args = array())
    {
        ...
        $parameters['collection'] = FormUtil::getPassedValue('collection', 0, 'GET');
        $parameters['mediaType'] = FormUtil::getPassedValue('mediaType', '', 'GET');
...
//              ->setMaxResults($resultsPerPage);
    ...
    protected function addCommonViewFilters(Doctrine\ORM\QueryBuilder $qb)
    {
        ...
        foreach ($parameters as $k => $v) {
            if ($k == 'catId') {
                 ...
                 */
                $categoryFiltersPerRegistry = ModUtil::apiFunc('SimpleMedia', 'category', 'buildFilterClauses', array('ot' => 'medium', 'catids' => $v));
    ...
    protected function getQueryFromBuilder(Doctrine\ORM\QueryBuilder $qb)
    {
        ...
        //$fu = new FilterUtil('SimpleMedia', $this);
