...
/**
 * Mime and file type related helper methods.
 */
class SimpleMedia_Util_Mime
{
    /**
     * Retrieve the way of displaying a file.
     */
    public function getInlineSnippetName($mimetype)
    {
        $res = false;
        ...
        switch ($mimetype) {
            ...
            case 'application/x-zip-compressed':
                                    $res = 'unknown';//'comp_zip';
                                    break;
            case 'application/x-rar':                      // RAR
                                    $res = 'unknown';//'comp_rar';
                                    break;
            case 'application/tar':                        // TAR
            case 'application/x-tar':
            case 'application/x-gtar':
                                    $res = 'unknown';//'comp_tar';
                                    break;
    ...
    /**
     * Guess a mimetype by it's extension.
     */
    public function guessMimetypeFromExtension($extension)
    {
        $res = 'unknown';
