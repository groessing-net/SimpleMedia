 ...
 */
class SimpleMedia_Api_Base_Cache extends Zikula_AbstractApi
{
    /**
    ...
    public function clearItemCache($args)
    {
        ...
        $cacheIds[] = 'SimpleMedia/user/main'; // main function
        $cacheIds[] = 'SimpleMedia/user/view/' . $objectType; // view function (list views)
