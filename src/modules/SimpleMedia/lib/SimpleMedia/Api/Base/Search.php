 ...
 */
class SimpleMedia_Api_Base_Search extends Zikula_AbstractApi
{
    /**
    ...
    public function search($args)
    {
        ...
        $searchTypes = isset($args['objectTypes']) ? (array)$args['objectTypes'] : (array)FormUtil::getPassedValue('search_simplemedia_types', array(), 'GETPOST');
