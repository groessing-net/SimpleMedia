...
<div style="margin-left: 80px">
    <div class="z-formrow">
        {formlabel for='simpleMediaObjectType' __text='Object type'}
            {simplemediaObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='simpleMediaObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes}
    ...
    <div{* class="z-formrow"*}>
        ...
        {simplemediaItemSelector id='id' group='data' objectType=$objectType}
    </div>
