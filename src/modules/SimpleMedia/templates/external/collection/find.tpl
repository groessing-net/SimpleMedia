...
<body>
    ...
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                <label for="SimpleMedia_objectid">{gt text='Collection'}:</label>
                <div id="simmeditemcontainer">
                    <ul>
                    {foreach item='collection' from=$objectData}
                        <li>
                            <a href="#" onclick="simplemedia.finder.selectItem({$collection.id})" onkeypress="simplemedia.finder.selectItem({$collection.id})">
                                {$collection.title}
                            </a>
                            ...
                            <input type="hidden" id="title{$collection.id}" value="{$collection.title|replace:"\"":""}" />
