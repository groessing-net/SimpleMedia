                    ...
                    <td headers="hPreviewImage" class="z-right">
                        {if $collection.previewImage != 0}
                            ...
                            {if !empty($previewImageMedium) && $previewImageMedium.theFileMeta.isImage}
                                <a href="{$previewImageMedium.theFileFullPathURL}" title="{$previewImageMedium->getTitleFromDisplayPattern()|replace:"\"":""}"{if $previewImageMedium.theFileMeta.isImage} rel="imageviewer[medium]"{/if}>
                                    {thumb image=$previewImageMedium.theFileFullPath tag='true' width=30 height=20}
                                </a>
                            {/if}
                        {else}
