...
<div class="z-formrow">
    <label for="simpleMediaObjectType">{gt text='Object type'}:</label>
        <select id="simpleMediaObjectType" name="objecttype" size="1">
...
<div class="z-formrow">
    <label for="simpleMediaSorting">{gt text='Sorting'}:</label>
        <select id="simpleMediaSorting" name="sorting">
...
<div class="z-formrow">
    <label for="simpleMediaAmount">{gt text='Amount'}:</label>
        <input type="text" id="simpleMediaAmount" name="amount" maxlength="2" size="10" value="{$amount|default:"5"}" />
</div>

<div class="z-formrow">
    <label for="simpleMediaTemplate">{gt text='Template'}:</label>
        <select id="simpleMediaTemplate" name="template">
...
<div id="customTemplateArea" class="z-formrow z-hide">
    <label for="simpleMediaCustomTemplate">{gt text='Custom template'}:</label>
        <input type="text" id="simpleMediaCustomTemplate" name="customtemplate" size="40" maxlength="80" value="{$customTemplate|default:''}" />
        <span class="z-sub z-formnote">{gt text='Example'}: <em>itemlist_{$objecttype}_display.tpl</em></span>
</div>

<div class="z-formrow z-hide">
    <label for="simpleMediaFilter">{gt text='Filter (expert option)'}:</label>
        <input type="text" id="simpleMediaFilter" name="filter" size="40" value="{$filterValue|default:''}" />
