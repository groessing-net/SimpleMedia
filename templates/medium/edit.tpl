...
{form enctype='multipart/form-data' cssClass='z-form'}
    ...
    <fieldset>
        ...
        <div class="z-formrow">
            ...
            {/if}
                ...
                <span class="z-formnote">{gt text='Allowed file extensions:'} <span id="theFileFileExtensions">gif, jpeg, jpg, png, pdf, doc, xls, ppt, docx, xlsx, pptx, odt, ods, odp, arj, zip, rar, tar, tgz, gz, bz2, txt, rtf, swf, flv, mp3, mp4, avi, mpg, mpeg, mov</span></span>
            <span class="z-formnote">{gt text='Allowed file size:'} {'5000000'|simplemediaGetFileSize:'':false:false}</span>
            {if $mode ne 'create'}
    ...
    {include file='helper/include_attributes_edit.tpl' obj=$medium}
    {include file='helper/include_categories_edit.tpl' obj=$medium groupName='mediumObj'}
    {include file='collection/include_selectEditOne.tpl' group='medium' alias='collection' aliasReverse='media' mandatory=true idPrefix='simmedMedium_Collection' linkingItem=$medium displayMode='dropdown' allowEditing=true}
    {include file='helper/include_metadata_edit.tpl' obj=$medium}
    {if $mode ne 'create'}
        {include file='helper/include_standardfields_edit.tpl' obj=$medium}
    {/if}
    ...
    /* <![CDATA[ */
        ...
        Event.observe(window, 'load', function() {
            ...
            {{*
                ...
                simmedInitGeoCoding(determineAddressForGeoCoding);
            *}}
        });
    /* ]]> */
    </script>
