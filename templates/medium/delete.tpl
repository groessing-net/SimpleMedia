{* purpose of this template: media delete confirmation view *}
...
<div class="simplemedia-medium simplemedia-delete">
    ...
    <form class="z-form" action="{modurl modname='SimpleMedia' type=$lct func='delete' ot='medium'  id=$medium.id}" method="post">
        <div>
            ...
            <fieldset>
                ...
                <div class="z-buttons z-formbuttons">
                    ...
                    <a href="{modurl modname='SimpleMedia' type=$lct func='view' ot='medium'}">{icon type='cancel' size='small' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
                </div>
            </fieldset>
