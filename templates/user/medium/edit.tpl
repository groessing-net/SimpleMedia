...
{form enctype='multipart/form-data' cssClass='z-form'}
    ...
    {include file='user/include_attributes_edit.tpl' obj=$medium}
    {include file='user/include_categories_edit.tpl' obj=$medium groupName='mediumObj'}
    {include file='user/collection/include_selectEditOne.tpl' group='medium' alias='collection' aliasReverse='media' mandatory=true idPrefix='simmedMedium_Collection' linkingItem=$medium displayMode='dropdown' allowEditing=true}
    {include file='user/include_metadata_edit.tpl' obj=$medium}
    {if $mode ne 'create'}
        {include file='user/include_standardfields_edit.tpl' obj=$medium}
    {/if}
