...
<div class="simplemedia-medium simplemedia-display">
    ...
    <dl>
        ...
        {if isset($medium.Collection) && $medium.Collection ne null}
          ...
          {/strip}</a>
          <a id="collectionItem{$medium.Collection.id}Display" href="{modurl modname='SimpleMedia' type='admin' func='display' ot='collection' id=$medium.Collection.id theme='Printer'}" title="{gt text='Open quick view window'}" class="z-hide">{icon type='view' size='extrasmall' __alt='Quick view'}</a>
    ...
    {include file='admin/include_attributes_display.tpl' obj=$medium}
    {include file='admin/include_categories_display.tpl' obj=$medium}
    {include file='admin/include_metadata_display.tpl' obj=$medium}
    {include file='admin/include_standardfields_display.tpl' obj=$medium}
