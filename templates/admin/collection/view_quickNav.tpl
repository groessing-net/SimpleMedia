...
<form action="{$modvars.ZConfig.entrypoint|default:'index.php'}" method="get" id="simpleMediaCollectionQuickNavForm" class="simplemedia-quicknav">
    <fieldset>
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        simmedInitQuickNavigation('collection', 'admin');
