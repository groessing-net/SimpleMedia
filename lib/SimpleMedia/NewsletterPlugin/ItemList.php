 ...
 */
class SimpleMedia_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('Latest SimpleMedia items');
    }
    ...
    {
        return $this->__('List of media and other SimpleMedia items');
    }
    ...
    {
        return $this->__('This plugin shows a list of media and other items of the SimpleMedia module.');
    }
    ...
    public function getParameters()
    {
        ...
        if (ModUtil::available($this->modname) && ModUtil::loadApi($this->modname)) {
            $objectTypes['medium'] = array('name' => $this->__('Media'));
