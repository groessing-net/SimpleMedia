 ...
 */
class SimpleMedia_Form_Handler_Collection_Base_Edit extends SimpleMedia_Form_Handler_Common_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $displayArgs = array('ot' => $this->objectType, 'id' => $this->idValues['id']);
