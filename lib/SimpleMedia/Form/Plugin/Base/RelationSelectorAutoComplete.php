 ...
 */
     ...
     */
    class SimpleMedia_Form_Plugin_Base_RelationSelectorAutoComplete extends SimpleMedia_Form_Plugin_AbstractObjectSelector
    {
        /**
        ...
        public function render(Zikula_Form_View $view)
        {
            ...
            switch ($this->objectType) {
                case 'medium':
                    $entityNameTranslated = __('medium', $dom);
                    break;
                case 'collection':
            ...
            $createLink = '';
            if ($this->createLink != '') {
                $createLink = '<a id="' . $idPrefix . 'SelectorDoNew" href="' . DataUtil::formatForDisplay($this->createLink) . '" title="' . __f('Create new %s', array($entityNameTranslated), $dom) . '" class="z-button simplemedia-inline-button">' . __('Create', $dom) . '</a>';
            }

            $alias = $this->id;

            $result = '
                <div class="simplemedia-relation-rightside">'
                    . $addLink . '
                    <div id="' . $idPrefix . 'AddFields">
                        ...
                        <div id="' . $idPrefix . 'SelectorChoices" class="simplemedia-autocomplete' . (($this->withImage) ? '-with-image' : '') . '"></div>
                        <input type="button" id="' . $idPrefix . 'SelectorDoCancel" name="' . $idPrefix . 'SelectorDoCancel" value="' . __('Cancel', $dom) . '" class="z-button simplemedia-inline-button" />'
                        . $createLink . '
