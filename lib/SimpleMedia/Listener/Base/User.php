 ...
 */
class SimpleMedia_Listener_Base_User
{
    /**
    ...
    public static function delete(Zikula_Event $event)
    {
        ...
        $repo = $entityManager->getRepository('SimpleMedia_Entity_Medium');
        // set creator to admin (2) for all media created by this user
        $repo->updateCreator($uid, 2);
        
        // set last editor to admin (2) for all media updated by this user
        $repo->updateLastEditor($uid, 2);
        
        $repo = $entityManager->getRepository('SimpleMedia_Entity_Collection');
