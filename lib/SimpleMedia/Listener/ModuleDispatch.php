 ...
 */
class SimpleMedia_Listener_ModuleDispatch extends SimpleMedia_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('SimpleMedia', 'user', 'main'), 'text' => __('Link Text'));
    }
}
